export const DEFAULT_QUICK_REPLIES = [
    { id: 6, label: 'HB',      color: '#16a085', message: '@HB HEARTBEAT <MYGRID4>' },
    { id: 1, label: 'CQ',      color: '#1a6fa8', message: '@ALLCALL CQ CQ CQ <MYGRID4>' },
    { id: 2, label: 'INFO',    color: '#27ae60', message: '<MYINFO>' },
